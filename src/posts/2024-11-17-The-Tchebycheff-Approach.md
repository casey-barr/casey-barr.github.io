---
title: "The Tchebycheff Approach"
description: "Minimising the largest weighted deviation from an ideal — and what that choice of norm commits you to when the deviations are values rather than errors."
topics: [mathematics, optimization, philosophy]
math: true
---

$$g = \max\{\, \lambda_i \left| f_i(x) - z_i^{*} \right| \,\}$$
